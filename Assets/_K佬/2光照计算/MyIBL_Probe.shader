    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                half4 env_color = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, reflect_dir, mip_level);
                ...
                half3 final_color = env_hdr_color * ao * _Tint.rgb * _Tint.rgb * _Expose;
